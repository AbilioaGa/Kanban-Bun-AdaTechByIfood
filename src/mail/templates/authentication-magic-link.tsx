...
export function AuthenticationMagicLinkTemplate({
  ...
  const previewText = `Faça login no Kanbanana`
        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
            ...
            <Heading className="text-black text-[24px] font-normal text-center p-0 my-[30px] mx-0">
              Faça login no Kanbanana
            </Heading>
            <Text className="text-black text-[14px] leading-[24px]">
              Você solicitou um link para login no Kanbanana através do email{' '}
              {userEmail}.
            </Text>
            <Section className="text-center mt-[32px] mb-[32px]">
              <Button
                className="bg-emerald-500 rounded text-white px-5 py-3 text-[12px] font-semibold no-underline text-center"
                href={authLink}
              >
                Entrar agora
              </Button>
